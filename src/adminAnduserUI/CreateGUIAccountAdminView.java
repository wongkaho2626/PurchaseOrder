...
public class CreateGUIAccountAdminView {
	...
	public CreateGUIAccountAdminView(String userID){
		this.userID = userID;
		initUI();
	}
	...
	private void setUP() {
		...
		// =========================
		accountLabel = new JLabel("Change your password (Admin)");
		...
		accountButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(StringUtils.isEmptyOrWhitespaceOnly(currentPassword)){
					JOptionPane
					.showMessageDialog(
							errorPanel,
					...
					MD5 md5 = new MD5();
					try {
						if(irbs.loginAdmin(userID, md5.getMD5(currentPassword))){
							if(passwordField1.getText().equals(passwordField2.getText())){
								irbs.setAdminPasswordData(userID, md5.getMD5(password));
								JOptionPane
								.showMessageDialog(
										null,
