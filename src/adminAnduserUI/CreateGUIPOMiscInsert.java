...
public class CreateGUIPOMiscInsert {
	...
	private void setUP() {
		...
		// =========================
		poInsertMiscLabel = new JLabel("Please insert Misc Purchase Order");
		gbc.weightx = 0;
		gbc.gridwidth = 9;
		gbc.gridx = 0;
		gbc.gridy = 0;
		...
		poInsertMiscNoTextField = new JTextField();
		gbc.gridwidth = 1;
		gbc.gridx = 0;
		gbc.gridy = 4;
		poInsertMiscPanel.add(poInsertMiscNoTextField, gbc);

		poInsertMiscOrderDateTextField[0] = new JTextField();
		gbc.gridwidth = 1;
		gbc.gridx = 1;
		gbc.gridy = 4;
		...
		poInsertMiscVendorTextField = new JTextField();
		gbc.gridwidth = 1;
		gbc.gridx = 3;
		gbc.gridy = 4;
...
//					poInsertMiscPanel.add(poInsertMiscDutyCodeTextField[cntMiscProduct], gbc);
		...
		poInsertMiscProductNoTextField[0] = new JTextField();
		gbc.gridwidth = 1;
		gbc.gridx = 0;
		gbc.gridy = 55;
		poInsertMiscProductNoTextField[0].addKeyListener(new KeyListener(){
			@Override
			public void keyTyped(KeyEvent e) {}
			...
			public void keyReleased(KeyEvent e) {
				IRBS irbs = new IRBS();
				String [] maintenanceStatement = irbs.maintenanceStatement(poInsertMiscProductNoTextField[0].getText());
				if(!poInsertMiscProductNoTextField[0].getText().equals("")){
		...
		poInsertMiscPanel.add(poInsertMiscProductNoTextField[0], gbc);

		poInsertMiscProductQuantityTextField[0] = new JTextField();
		gbc.gridwidth = 1;
		gbc.gridx = 2;
		gbc.gridy = 55;
		poInsertMiscProductQuantityTextField[0].addKeyListener(new KeyListener(){
			@Override
			public void keyTyped(KeyEvent e) {}
			...
			public void keyReleased(KeyEvent e) {
				...
				NumberFormat nf = new DecimalFormat("###,###,###,###,###");			
				if(!StringUtils.isEmptyOrWhitespaceOnly(poInsertMiscProductQuantityTextField[0].getText())){
					poInsertMiscProductQuantityTextField[0].setText(nf.format(Integer.parseInt(poInsertMiscProductQuantityTextField[0].getText().replace(",", ""))));
				}
		...
		poInsertMiscPanel.add(poInsertMiscProductQuantityTextField[0], gbc);
		
		poInsertMiscDescriptionTextField[0] = new JTextField();
		poInsertMiscDescriptionTextField[0].setEditable(false);
		gbc.gridwidth = 4;
		gbc.gridx = 3;
		gbc.gridy = 55;
		poInsertMiscPanel.add(poInsertMiscDescriptionTextField[0], gbc);
		
		poInsertMiscProductPriceTextField[0] = new JTextField();
		gbc.gridwidth = 1;
		gbc.gridx = 7;
		gbc.gridy = 55;
		poInsertMiscProductPriceTextField[0].addKeyListener(new KeyListener(){
			@Override
			public void keyTyped(KeyEvent e) {}
		...
		poInsertMiscPanel.add(poInsertMiscProductPriceTextField[0], gbc);
		
		poInsertMiscProductFixedCostTextField[0] = new JTextField();
//		gbc.gridwidth = 1;
//		gbc.gridx = 8;
//		gbc.gridy = 55;
//		poInsertMiscPanel.add(poInsertMiscProductFixedCostTextField[0], gbc);
		
		poInsertMiscDutyCodeTextField[0] = new JTextField();
//		poInsertMiscDutyCodeTextField[0].setEditable(false);
//		gbc.gridwidth = 1;
//		gbc.gridx = 9;
//		gbc.gridy = 55;
//		poInsertMiscPanel.add(poInsertMiscDutyCodeTextField[0], gbc);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					if(checkMiscAllInsert()){
						if(irbs.checkMiscDuplicatePO(Integer.parseInt(poInsertMiscNoTextField.getText()))){
							JOptionPane
							.showMessageDialog(
									errorPanel,
							...
							if (checkMiscDateValid() != null){
								...
								.showMessageDialog(
										null,
										"Success insert the new misc purchase order",
		...
		poInsertMiscRemarkTextArea = new JTextArea();
		gbc.gridwidth = 11;
		gbc.gridx = 0;
		gbc.gridy = 200002;
